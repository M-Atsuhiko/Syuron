...
%subfigure を入れるときに改行すると、実際の文章でも改行が反映され、横に並ばなくなるるので注意
     ...
     また, 2つの手法で生成された神経細胞の例を図\ref{passive_morphos}に示す. 
 ...
 \section{Kaチャネルを用いた場合の結果}
   ...
   の組に有為差が見られた際には赤い星印を図中上部につけている. 
     ...
     \begin{figure}[H]
       ...
       \begin{subfigure}{\columnwidth}
         \centering
         \includegraphics[width=0.4\columnwidth]{./Images_Result/k_test_legend.eps} 
       \end{subfigure}
       \vspace{-2.5cm}
