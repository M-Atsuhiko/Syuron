...
%subfigure を入れるときに改行すると、実際の文章でも改行が反映され、横に並ばなくなるるので注意
     ...
     有為差がみられたことを示す. 
     図\ref{Tsuishi_Rerative_F}と図\ref{Tsuishi_Rerative_volume}をみると
     2つの手法の間で機能性$F$にはあまり差は見られないが
     体積は明らかに小さくなっていることがわかる. 図\ref{Tsuishi_Rerative_Upper_Diam}と
     \ref{Tsuishi_Rerative_Lower_Diam}は, その原因が樹状突起の直径が小さくなったこと
     にあると示している. \\
     図\ref{Rerative_Neuron_result}は本研究手法によって得られた神経細胞
     の体積について, 図\ref{Rerative_Dend_result}は2つの樹状突起ごとの太さ
     (図\ref{Rerative_Diam})と形成されたシナプスの個数(図\ref{Rerative_N_Syn})を示す.
     
     \begin{figure}[H]
       \centering
       \includegraphics[width=0.4\columnwidth]{./Images_Result/passive_one_TREE_volume.eps}
       \caption{本研究手法で得られた神経細胞の体積}
       \label{Rerative_Neuron_result}
     \end{figure}
     ...
     \begin{figure}[H]
       ...
       \label{Rerative_Dend_result}
     \end{figure}
     図\ref{Rerative_Diam}でみられるようにUpper Dendriteの直径はすべての${\Delta}t$において
     明らかにLower Dendriteよりも太い. また図\ref{Rerative_N_Syn}に示されるようにBlue
