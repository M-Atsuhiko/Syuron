...
結果を示す. 図中の凡例や検定手法とその結果の示し方は図\ref{Ka_Result1}と同様である.
     ...
     \begin{figure}[H]
       ...
       \begin{subfigure}{0.5\columnwidth}
         \centering
         \hspace*{-1cm}
         \includegraphics[width=0.5\columnwidth]{./Images_Result/k_ca_test_legend.eps}
...
%付録にする
     ...
     \begin{figure}[H]
       ...
       \begin{subfigure}{0.62\columnwidth}
         \centering
         \includegraphics[width=\columnwidth]{./Images_Result/k_ca_Rerative_liner_75_0_K_distribution_dt20.eps}
         \caption{線形分布}
         \label{k_ca_K_liner_reduced_dist}
       \end{subfigure}
       \begin{subfigure}{0.62\columnwidth}
         \centering
         \includegraphics[width=\columnwidth]{./Images_Result/k_ca_Rerative_liner_75_5_K_distribution_dt20.eps}
         \caption{線形分布(reduced)}
         \label{k_ca_K_liner_reduced_dist}
       \end{subfigure}
     ...
     \begin{figure}[H]
       ...
       \begin{subfigure}{0.62\columnwidth}
         \centering
         \includegraphics[width=\columnwidth]{./Images_Result/k_ca_Rerative_liner_75_0_Ca_distribution_dt20.eps}
         \caption{線形分布}
         \label{k_ca_Ca_liner_reduced_dist}
       \end{subfigure}
       \begin{subfigure}{0.62\columnwidth}
         \centering
         \includegraphics[width=\columnwidth]{./Images_Result/k_ca_Rerative_liner_75_5_Ca_distribution_dt20.eps}
         \caption{線形分布(reduced)}
         \label{k_ca_Ca_liner_reduced_dist}
       \end{subfigure}
